...
#define MAVLINK_ARDUPILOTMEGA_XML_HASH 2363070471919327963
...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_ASCENT_RID_HEALTH=48001, /* Used to report the health of the RID module |Health status of the Remote ID module| Empty| Empty| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ASCENT_RID_GCS=48002, /* Used to report/retrieve the position of the GCS |Latitude| Longitude| Altitude| Empty| Empty| Empty| Empty|  */
   MAV_CMD_ENUM_END=48003, /*  | */
} MAV_CMD;
#endif
...
#include "./mavlink_msg_ascent_remote_id_gcs_pos.h"
