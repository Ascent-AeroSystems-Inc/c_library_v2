...
typedef enum MAV_CMD
{
   ...
   MAV_CMD_ASCENT_RID_GCS=48002, /* Used to report/retrieve the position of the GCS |Latitude| Longitude| Altitude| Timestamp UTC| Emergency declared| Empty| Empty|  */
...
#include "./mavlink_msg_ascent_remote_id_gcs_data.h"
